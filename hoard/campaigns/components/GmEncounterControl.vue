<template>
  ...
  >
            ...
            >
              ...
              <td>
                <template v-if="hasTrackedHealth(combatant)">
                  ...
                  <HealthBar
                    :percentage="combatant.health_percentage ?? 0"
                    :label="`${combatant.name} health: ${combatant.current_hp} of ${combatant.max_hp}`"
                  />
                </template>
                <span
                  v-else
    ...
    >
      <p>
        The initiative order will close and the Party Rail will return to the roster.
      </p>
      <template #footer>
        <Button
          label="Cancel"
  ...
  methods: {
    ...
    async endCombat(): Promise<void> {
      ...
      try {
        ...
        this.$emit("completed", "Combat ended.");
      } catch (exception) {
