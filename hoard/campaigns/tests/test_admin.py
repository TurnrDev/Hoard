...
from hoard.campaigns.models import Campaign, Character, ExperienceEntry, InventoryEntry, MoneyEntry
...
class CharacterAdminTests(TestCase):
    def test_admin_activation_posts_shared_experience_baseline(self) -> None:
        ...
        model_admin.save_model(RequestFactory().post('/admin/'), character, form, change=False)
