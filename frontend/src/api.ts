...
export const copyItem = (
  ...
  request<Item>(`/api/campaigns/${campaignId}/items/${itemId}/copy/`, {
    method: "POST",
    body: JSON.stringify({ name, description, metadata }),
  });
export const postAction = (
  ...
  request(`/api/campaigns/${campaignId}/actions/${action}/`, {
    method: "POST",
...
export const reverseTransaction = (
  ...
  request(
    `/api/campaigns/${campaignId}/transactions/${transaction.ledger}/${transaction.id}/reverse/`,
